<template>
    <div class="modal">
        ...
        <div class="text-field text-field_floating">
            <input class="text-field__input" type="name" id="name" v-model="receiveDataLabel.name" />
            <label class="text-field__label" for="name">Наименование</label>
        </div>
        <div class="text-field text-field_floating">
            <input class="text-field__input" type="quantity" id="quantity" v-model="receiveDataLabel.quantity" />
            <label class="text-field__label" for="quantity">Значение</label>
        </div>
        <div class="text-field text-field_floating">
            <input class="text-field__input" type="colorIn" id="colorIn" v-model="receiveDataLabel.color" />
