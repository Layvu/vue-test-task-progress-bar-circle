    ...
    <div class="container">
        ...
        <div class="content">
            <ul class="conent-tabl">
                ...
                <div class="btn" style="margin-top: 30px" @click="addBtnSector">Добавить сектор</div>
            </ul>
...
const defSendDataLabel = () => {
    (sendDataLabel.name = 'sector'), (sendDataLabel.quantity = 25), (sendDataLabel.color = '#4F46E5');
};
